...

{
    ...
    if ([[result name] isEqualToString:@"Selectall_A_Gesture"])
    {
        [self SelectAllText:sender];
    }
    
    if ([[result name] isEqualToString:@"Copy_C_Gesture"])
    {
        
        [self CopyText:sender];
    }
    
    if ([[result name] isEqualToString:@"Paste_V_Gesture"])
    {
        [self PasteText:sender];
    }
    
    if ([[result name] isEqualToString:@"Cut_X_Gesture"])
    {
        [self CutText:sender];
    }
    
    if ([[result name] isEqualToString:@"Strikethrough_F_Gesture"])
    {
    ...
    if ([[result name] isEqualToString:@"Underline_U_Gesture"])
    {
    ...
    if ([[result name] isEqualToString:@"Delete_D_Gesture"])
    {
        [self DeleteText:sender];
    }
    if ([[result name] isEqualToString:@"Fontsize_P_Gesture"])
    {
        [self FontTypeText:sender];
    }
    if ([[result name] isEqualToString:@"Undo_Z_Gesture"])
    {
        [self UndoText:sender];
    }
    
    if ([[result name] isEqualToString:@"Redo_Y_Gesture"])
    {
        [self RedoText:sender];
    }
    if ([[result name] isEqualToString:@"Bold_B_Gesture"])
    {
        NSLog(@"I'm bold");
    ...
    if ([[result name] isEqualToString:@"Paragraphstyle_J_Gesture"])
    {
        [self ParagraphStyleText:sender];
    }
    
    if ([[result name] isEqualToString:@"Fontfamily_T_Gesture"])
    {
        [self FontTypeText:sender];
    }
    
    if ([[result name] isEqualToString:@"Highlight_H_Gesture"])
    {
        [self HighlightText:sender];
        
    }
    
    if ([[result name] isEqualToString:@"Fontcolor_R_Gesture"])
    {
        [self FontColorText:sender];
        
    }
    
    if ([[result name] isEqualToString:@"Shadow_S_Gesture"])
    {
        NSLog(@"I'm Shadow");
...
# pragma mark Methods for textEditor
...
-(IBAction)UndoText:(id)sender
{
    ...
    [self.myTextView becomeFirstResponder];
     undoManager =  [self.myTextView undoManager];
    [undoManager undo];
...
{
    [self.myUIView resignFirstResponder];
    [self.myTextView becomeFirstResponder];
     undoManager = [self.myTextView undoManager];
    [undoManager redo];
